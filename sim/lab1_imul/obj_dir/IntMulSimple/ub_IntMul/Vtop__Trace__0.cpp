...
void Vtop___024root__trace_chg_sub_0(Vtop___024root* vlSelf, VerilatedFst::Buffer* bufp) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[4U])) {
        ...
        bufp->chgIData(oldp+271,(vlSelf->top__DOT__ostream_msg),32);
        bufp->chgIData(oldp+272,(vlSelf->top__DOT__imul__DOT__vc_trace__DOT__cycles),32);
    }
    bufp->chgBit(oldp+273,(vlSelf->clk));
    bufp->chgBit(oldp+274,(vlSelf->linetrace));
    bufp->chgQData(oldp+275,(vlSelf->top__DOT__istream_msg),64);
    bufp->chgIData(oldp+277,((IData)((vlSelf->top__DOT__istream_msg 
                                      >> 0x20U))),32);
    bufp->chgIData(oldp+278,((IData)(vlSelf->top__DOT__istream_msg)),32);
