...
#endif
                VL_FATAL_MT("ub_IntMul.v", 20, "", "Input combinational region did not converge.");
            }
...
#endif
                    VL_FATAL_MT("ub_IntMul.v", 20, "", "Active region did not converge.");
                }
...
#endif
                VL_FATAL_MT("ub_IntMul.v", 20, "", "NBA region did not converge.");
            }
