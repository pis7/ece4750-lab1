...
VL_ATTR_COLD void Vtop_vc_Mux2__P20___configure_coverage(Vtop_vc_Mux2__P20* vlSelf, bool first) {
    ...
    vlSelf->__vlCoverInsert(&(vlSymsp->__Vcoverage[567]), first, "../vc/muxes.v", 24, 12, "", "v_line/vc_Mux2__P20", "case", "24");
    vlSelf->__vlCoverInsert(&(vlSymsp->__Vcoverage[568]), first, "../vc/muxes.v", 25, 12, "", "v_line/vc_Mux2__P20", "case", "25");
    vlSelf->__vlCoverInsert(&(vlSymsp->__Vcoverage[569]), first, "../vc/muxes.v", 26, 7, "", "v_line/vc_Mux2__P20", "case", "26");
    vlSelf->__vlCoverInsert(&(vlSymsp->__Vcoverage[570]), first, "../vc/muxes.v", 21, 3, "", "v_line/vc_Mux2__P20", "block", "21-23");
}
