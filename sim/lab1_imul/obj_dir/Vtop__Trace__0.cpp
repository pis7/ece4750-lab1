...
void Vtop___024root__trace_chg_sub_0(Vtop___024root* vlSelf, VerilatedFst::Buffer* bufp) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[4U])) {
        ...
        bufp->chgIData(oldp+286,((vlSelf->top__DOT__imul__DOT__datapath__DOT__b_reg_out 
                                  >> 1U)),32);
        bufp->chgIData(oldp+287,(vlSelf->top__DOT__imul__DOT__datapath__DOT__a_reg_out),32);
        bufp->chgIData(oldp+288,((vlSelf->top__DOT__imul__DOT__datapath__DOT__a_reg_out 
                                  << 1U)),32);
        bufp->chgIData(oldp+289,(vlSymsp->TOP__top__DOT__imul__DOT__datapath__DOT__result_mux.out),32);
        bufp->chgIData(oldp+290,(vlSelf->top__DOT__imul__DOT__datapath__DOT__adder_out),32);
        bufp->chgIData(oldp+291,(vlSymsp->TOP__top__DOT__imul__DOT__datapath__DOT__adder_mux.out),32);
        bufp->chgIData(oldp+292,(vlSelf->top__DOT__imul__DOT__vc_trace__DOT__cycles),32);
    }
    bufp->chgBit(oldp+293,(vlSelf->clk));
    bufp->chgBit(oldp+294,(vlSelf->linetrace));
    bufp->chgQData(oldp+295,(vlSelf->top__DOT__istream_msg),64);
