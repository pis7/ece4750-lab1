...
#endif
                VL_FATAL_MT("tb_IntMulUVM.v", 33, "", "Input combinational region did not converge.");
            }
...
#endif
                    VL_FATAL_MT("tb_IntMulUVM.v", 33, "", "Active region did not converge.");
                }
...
#endif
                VL_FATAL_MT("tb_IntMulUVM.v", 33, "", "NBA region did not converge.");
            }
