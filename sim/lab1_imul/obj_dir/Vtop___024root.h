...
class alignas(VL_CACHE_LINE_BYTES) Vtop___024root final : public VerilatedModule {
  public:
    ...
    struct {
        ...
        CData/*4:0*/ top__DOT__imul__DOT__datapath__DOT__b_r_shifter__DOT____Vtogcov__shamt;
        ...
        CData/*0:0*/ __Vtask_top__DOT__imul__DOT__control__DOT__tab__138__t_add_mux_sel;
